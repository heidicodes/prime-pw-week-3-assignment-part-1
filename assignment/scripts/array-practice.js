...
let favoriteFoods = ['spaghetti', 'pizza', 'tacos'];
...
console.log('Number of food items:', favoriteFoods.length);
...
console.log('Second food listed is', favoriteFoods[1]);

// 3.b. TODO: Log the last animal in the array using it's array index 
console.log('Last food listed is', favoriteFoods[2]);

// 3.c. (STRETCH) TODO: Log the last animal by using the array length, 
//      instead of the exact index number of the last item
console.log('Last food listed is', favoriteFoods[favoriteFoods.length - 1]);
...
console.log('Added new food item to end,', favoriteFoods);
...
favoriteFoods.unshift('adobo');
console.log(`Added food item to beginning: ${favoriteFoods}`);
...
let favoriteFoodsStr = favoriteFoods.join(' and '); // Using array method 'join' to convert to string
    // Using "and" as the separator argument for method; default is comma
console.log('Array is now a string of items:', favoriteFoodsStr); // logs favorite foods as string
